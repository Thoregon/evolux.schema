...
export default class Repository extends RepoMirror(Reporter(EventEmitter), 'schema') {
    ...
    putSchema(id, schema) {
        ...
        this._addToMirror(id, schema);   // shortcut for convenience
